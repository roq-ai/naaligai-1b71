...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['app-owner', 'app-developer', 'app-administrator', 'data-analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Time', path: '/times', entity: 'time', service: AccessServiceEnum.PROJECT, icon: FiClock },
